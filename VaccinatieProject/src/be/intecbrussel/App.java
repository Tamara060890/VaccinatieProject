...
public class App {
    public static void main(String[] args) {
        ...
        shelter.addAnimal(new Cat("Minoes", 4, true, true));
        shelter.addAnimal(new Monkey("George", 10, false, false));
        shelter.addAnimal(new Dog("Bello", 6, false, true));
        ...
        System.out.println("--Alle dieren die niet schoon zijn--");
        shelter.printAnimalsNotClean();
